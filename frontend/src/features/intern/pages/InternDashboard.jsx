...
export default function InternDashboard() {
  ...
  const handlePasswordFieldChange = ({ target }) => {
  ...
  const handlePasswordChange = async (event) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/intern/change-password`,
        {
          method: 'PUT',
          credentials: 'include',
          headers: {
        ...
        {activeNav === 'certificates' && (
          <>
            <section
              ...
              aria-label="Certificate requests"
            >
              <div>
                ...
                <p>
                  Choose a certificate and follow its
                  progress here.
                </p>
              </div>
        ...
        {activeNav === 'dashboard' &&
          ...
          profile && (
            <>
              ...
              >
                <div className="id-profile-header">
                  ...
                  <div className="id-profile-identity">
                    <h2 className="id-profile-name">
                      {profile.fullName}
                    </h2>

                    <p className="id-profile-email">
                      ✉️ {profile.email}
                    </p>
              ...
              {/* Stat Grid */}
              <div
                className="id-stat-grid"
                aria-label="Quick stats"
              >

                <div className="id-stat-card">
                  <div className="id-stat-icon accent">
                    🎭
                  </div>

                  <div className="id-stat-label">
                    Role
                  </div>

                  <div className="id-stat-value accent">
                    {profile.role}
                  </div>
                </div>

                <div className="id-stat-card">
                  <div className="id-stat-icon success">
                    💻
                  </div>
                  ...
                  <div className="id-stat-value success">
                    {profile.domain}
                  </div>
                </div>

                <div className="id-stat-card">
                  <div className="id-stat-icon warning">
                    ⏳
                  </div>
                  ...
                  <div className="id-stat-value warning">
                    {daysLeft}
                  </div>
                </div>

                <div className="id-stat-card">
                  <div className="id-stat-icon info">
                    📊
                  </div>
                  ...
                  <div className="id-stat-value info">
                    {progress}%
                  </div>
                </div>
              ...
              {/* Change Password */}
              <section
                className="id-password-section"
                aria-label="Change password"
              >
                <div className="id-password-card">
                  ...
                  <p>
                    Update your temporary password to
                    a permanent password.
                  </p>

                  <form
                    className="id-password-form"
                    onSubmit={handlePasswordChange}
                  >

                    <label className="id-password-field">
                      <span>
                        Current password
                      </span>
                    ...
                    {passwordStatus && (
                      <p
                        className={`id-password-message ${passwordStatus.type}`}
                        role="status"
                      >
