...
const InternDashboard = () => {
    ...
    const loadRequests = async () => {
        try {
            ...
            const data = await getMyCertificateRequests();
    ...
    const internship = useMemo(() => {
        const requestWithInternship = requests.find(
            (request) =>
                request?.internshipId &&
                typeof request.internshipId === "object"
        );

        return requestWithInternship?.internshipId || null;
    }, [requests]);
    ...
    const handleSubmit = async (e) => {
        ...
        if (!internship?._id) {
            setError(
                "Unable to determine your internship. Please contact HR."
            );
            return;
        }
        ...
        <div className={darkMode ? "portal dark" : "portal"}>
            ...
            <aside className="sidebar">
                ...
                <div className="sidebar-content">
                    ...
                    <div className="nav-label account-label">
                        ACCOUNT
                    </div>
            ...
            <main className="main">
                ...
                <div className="content">
                    ...
                    <section className="hero">
                        ...
                        <div className="hero-content">
                            ...
                            <p>
                                ...
                                your internship journey and
                                certificate requests in one
                                secure place.
                            </p>
                    ...
                    >
                        ...
                        {loading ? (
                            ...
                            <div className="empty-card">
                                ...
                                <h3>
                                    No internship information
                                </h3>

                                <p>
                                    No internship record was
                    ...
                    <footer>
                        © 2026 UpToSkills · Internship Portal
                    </footer>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                <textarea
                                    ...
                                    placeholder="Add any additional information for HR..."
                                    rows="4"
                                    disabled={submitting}
                                />
...
.brand-logo {
    ...
    box-shadow:
        0 10px 30px rgba(111,82,246,.35);
...
.primary-button {
    ...
    box-shadow:
        0 10px 24px rgba(105,76,230,.25);
}

.primary-button:hover {
    transform: translateY(-2px);
    box-shadow:
        0 14px 30px rgba(105,76,230,.32);
}
...
.floating-card {
    ...
    box-shadow:
        0 20px 50px rgba(64,48,125,.12);

    backdrop-filter: blur(12px);
}

.dark .floating-card {
    background: rgba(28,25,44,.8);
    border-color: #3b354f;
}
...
.internship-card {
    ...
    box-shadow:
        0 10px 35px rgba(55,45,100,.055);
}
...
.certificate-icon.participation {
    background: #fff4dc;
    color: #dc921e;
}

.certificate-icon.experience {
    background: #eaf7ff;
    color: #3387b8;
}
...
.spinner {
    ...
    border: 3px solid #e8e4f7;
    border-top-color: #7059e9;
...
.certificate-option.selected {
    ...
    box-shadow:
        0 5px 18px rgba(110,88,224,.1);
}

.dark .certificate-option.selected {
    background: #25203a;
}
